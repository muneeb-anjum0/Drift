...
func TestSummaryReadsLatestEvaluationReport(t *testing.T) {
	...
	latest := writeReport(t, dir, "latest.json", `{"schemaVersion":1,"generatedAt":"2026-07-07T11:00:00Z","mode":"q4","model":{"label":"Qwen2.5-7B + DriftLedger LoRA","quantization":"Q4_K_M","runtime":"Local GGUF / llama.cpp","health":"ok","modelLoaded":true,"ggufModelPath":"/app/models/gguf/model.gguf"},"passCount":8,"caseCount":8,"passRate":100,"averageLatencyMs":9610,"recommendation":"ready","cases":[{"id":"sms","name":"SMS OTP","expectedLabel":"added","actualLabel":"added","score":35,"impact":"medium","estimatedHours":6,"latencyMs":1200,"passed":true,"title":"Add SMS OTP Password Reset","summary":"clean","reasoning":"clean","notes":[]}]}`)
